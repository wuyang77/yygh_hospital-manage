...
public class ApiServiceImpl implements ApiService {
    ...
    public boolean saveSchedule(String data) {
        ...
        //新建立一个数组，如果这个data不是一个起始含[数组，则把data解析转换为jsonObject对象，然后在将该对象添加到jsonArray这个数组中
        //否则直接将这个data解析转换为jsonArray对象
        //这一段代码的意思是说，不管data是不是jsonArray对象，都要将其转换为jsonArray数组对象
